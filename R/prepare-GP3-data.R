...
process_GP3_dataframe <- function(df) {
  
  n_df <- retrieve_n_table(df, c(ROUND_NUMBER_COL, MEASURE_ALIAS_COL, MEASURE_ICONS_COL, MEASURE_COSTREF_COL), "id")
  n_df <- create_GP3_xlabels(df)
}
